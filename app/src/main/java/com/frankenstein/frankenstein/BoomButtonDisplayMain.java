...
public class BoomButtonDisplayMain {
    ...
    public BoomButtonDisplayMain(BoomMenuButton boomMenuButton){
        mBoomButton = boomMenuButton;
    }

    public void mapFragmentDisplay(final Context context, final GoogleMap mMap, final Marker mCurrentMarker
            , final ArrayList<Marker> mAllMarkers, final Marker mCurrentMarkerSelected
            , final Marker mCustomLocationMarker){
    ...
    public void arFragmentDisplay(final Context context){
        if (mBoomButton.getBuilders() != null) mBoomButton.clearBuilders();
        mBoomButton.setInFragment(true);
        mBoomButton.setButtonEnum(ButtonEnum.TextOutsideCircle);
        mBoomButton.setPiecePlaceEnum(PiecePlaceEnum.DOT_5_3);
