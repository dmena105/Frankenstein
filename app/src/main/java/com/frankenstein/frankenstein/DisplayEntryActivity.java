...
public class DisplayEntryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        markerId = getIntent().getLongExtra("ID", -1);
        if (markerId == -1) {
            ...
            Thread displayEntry = new Thread(new Runnable() {
                @Override
                public void run() {
                    ...
                    refUtil.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onDataChange(DataSnapshot dataSnapshot) {
                            // TODO: Read profile and the corresponding item
                            Log.d("debug", "Read from Firebase");
                        }
